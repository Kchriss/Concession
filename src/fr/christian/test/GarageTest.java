...
public class GarageTest {
	...
	public static void main(String[] args) {
	   	 ...
	   	 System.out.println("***************************************************");
	   	 System.out.println("*** stock après suppression des doublons garage ***");
	   	 System.out.println("***************************************************");
	...
	public void testGarage() {
		Garage garage = new Garage();
		assertNotNull("L'instance n'est pas créée", garage);
		
	}

	@Test
	public void testGarageListOfVehicule() {
		assertNotNull("La liste n'est pas créée", garage.getVoitures());
